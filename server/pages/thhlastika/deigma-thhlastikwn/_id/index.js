...
module.exports.__inject__ = function (context) {
  add("0a997964", content, true, context)
};
...
/* harmony default export */ var _idvue_type_script_lang_js_ = ({
  head() {
    return {
      title: 'Δείγμα Θηλαστικών - Προβολή | Φορέας Διαχείρισης Λίμνης Κερκίνης',
      meta: [{
        hid: 'description',
        name: 'description',
        content: 'Προβολή συγκεκριμένου Δείγματος Θηλαστικών για τη διαχείρηση δεδομένων των Δειγμάτων Θηλαστικών για τον Φορέα Διαχείρισης Λίμνης Κερκίνης.'
      }]
    };
  },
  ...
  data() {
    return {
      main: {
        title: 'Αναζήτηση Δείγματος Θηλαστικού με id ' + this.$route.params.id,
        emptyElements: 'Δεν βρέθηκε αποθηκευμένο το Δείγμα Θηλαστικών που επιθυμείτε',
        titlePicture: 'Προσθέστε νέα φωτογραφία για το Δείγμα Θηλαστικών',
        subTitlePicture: 'Πατήστε για να επιλέξετε ή μεταφέρετε εδώ την φωτογραφία',
        titleFile: 'Προσθέστε νέο αρχείο (pdf / excel / word) για το Δείγμα Θηλαστικών',
  ...
  computed: {
    ...
    addPictureUrl() {
      return this.$store.getters.getDeigmaThhlastikwnByIdUrl + this.id + '/addPicture';
    },

    addFileUrl() {
      return this.$store.getters.getDeigmaThhlastikwnByIdUrl + this.id + '/addFile';
    },
  ...
  methods: {
    ...
    toIdEditPage(id) {
      this.$router.push('/thhlastika/deigma-thhlastikwn/' + id + '/edit');
    },
    ...
    goToPicturesPage() {
      this.$router.push('/thhlastika/deigma-thhlastikwn/' + this.id + '/pictures/');
    },

    goToFilesPage() {
      this.$router.push('/thhlastika/deigma-thhlastikwn/' + this.id + '/files/');
    },

    goToXEidhPage() {
      this.$router.push('/thhlastika/deigma-thhlastikwn/' + this.id + '/x-eidh/');
    },

    goToXPressThreatsPage() {
      this.$router.push('/thhlastika/deigma-thhlastikwn/' + this.id + '/x-press-threats/');
    }

  }
});
// CONCATENATED MODULE: ./pages/thhlastika/deigma-thhlastikwn/_id/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var deigma_thhlastikwn_idvue_type_script_lang_js_ = (_idvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/thhlastika/deigma-thhlastikwn/_id/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  deigma_thhlastikwn_idvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
