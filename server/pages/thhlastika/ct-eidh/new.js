...
module.exports.__inject__ = function (context) {
  add("158c086b", content, true, context)
};
...
/* harmony default export */ var newvue_type_script_lang_js_ = ({
  ...
  data() {
    return {
      ...
      validation: false,
      eidosRules: [v => !!v || 'Συμπληρώστε το πεδίο Είδος', v => v.length <= 100 || 'Το πεδίο πρέπει να είναι λιγότερο από 255 χαρακτήρες'],
      selectedFile: null,
      snackbar: false,
      snackbarText: '',
      snackbarColor: ''
  ...
  computed: {
    addFormUrl() {
      return this.$store.getters.getThhlastikaCtEidosAddUrl;
    },

    addFromExcelUrl() {
      return this.$store.getters.getThhlastikaCtEidosAddFromExcelUrl;
    },
  ...
  methods: {
    ...
    submitForm() {
      ...
      this.$axios.post(this.addFormUrl, checkedForm).then(response => {
        this.$router.push('/thhlastika/ct-eidh/' + response.data.id);
      }).catch(error => {
...
// CONCATENATED MODULE: ./pages/thhlastika/ct-eidh/new.vue?vue&type=script&lang=js&
 /* harmony default export */ var ct_eidh_newvue_type_script_lang_js_ = (newvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/thhlastika/ct-eidh/new.vue
