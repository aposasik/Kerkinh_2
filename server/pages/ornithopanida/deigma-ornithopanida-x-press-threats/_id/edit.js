...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/ornithopanida/deigma-ornithopanida-x-press-threats/_id/edit.vue?vue&type=template&id=4e0e93e0&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-container',{attrs:{"fluid":""}},[_c('v-layout',{attrs:{"row":"","wrap":"","align-center":"","justify-center":""}},[_c('v-flex',{staticClass:"text-xs-center",attrs:{"xs12":"","mt-5":""}},[_c('h2',{staticClass:"headline"},[_vm._v(" "+_vm._s(_vm.main.title)+" ")])]),_vm._v(" "),(_vm.loading == true)?_c('v-flex',{staticClass:"text-xs-center mt-5",attrs:{"xs8":"","sm6":"","md2":""}},[_c('v-progress-circular',{attrs:{"indeterminate":"","size":"45","color":"green lighten-1"}})],1):_vm._e(),_vm._v(" "),(_vm.noElements == true)?_c('v-flex',{staticClass:"text-xs-center text-md-left",staticStyle:{"margin-top":"130px"},attrs:{"xs12":"","lg11":""}},[_c('h3',{staticClass:"font-weight-regular"},[_vm._v(" "+_vm._s(_vm.main.emptyElements)+" ")])]):(_vm.noElements == false)?_c('v-flex',{staticStyle:{"margin-top":"100px"},attrs:{"xs12":"","lg10":""}},[_c('div',{staticClass:"my-5"},[_c('v-card',[_c('div',{staticClass:"green lighten-4",staticStyle:{"width":"100%","height":"7px"}}),_vm._v(" "),_c('v-form',{ref:"form",staticClass:"pa-4",model:{value:(_vm.validation),callback:function ($$v) {_vm.validation=$$v},expression:"validation"}},[_c('v-layout',{attrs:{"wrap":"","justify-space-around":""}},[_c('v-flex',{attrs:{"xs12":"","md4":"","my-4":""}},[_c('v-text-field',{attrs:{"label":"Δείγμα Θηλαστικών Id","color":"green","rules":_vm.deigmaOrnithopanidaidRules,"required":""},model:{value:(_vm.deigmaXPressThreat.deigmaOrnithopanida.id),callback:function ($$v) {_vm.$set(_vm.deigmaXPressThreat.deigmaOrnithopanida, "id", $$v)},expression:"deigmaXPressThreat.deigmaOrnithopanida.id"}})],1),_vm._v(" "),_c('v-flex',{attrs:{"xs12":"","md4":"","my-4":""}},[_c('v-autocomplete',{attrs:{"label":"Ct Πίεσης","color":"green","items":_vm.ctActCodesList,"rules":_vm.ctActCodeRules,"no-data-text":"Δεν βρέθηκαν δεδομένα","required":""},model:{value:(_vm.deigmaXPressThreat.ctornithopanidaPressuresAndThreats.actCode),callback:function ($$v) {_vm.$set(_vm.deigmaXPressThreat.ctornithopanidaPressuresAndThreats, "actCode", $$v)},expression:"deigmaXPressThreat.ctornithopanidaPressuresAndThreats.actCode"}})],1)],1),_vm._v(" "),_c('v-layout',{attrs:{"wrap":"","justify-space-around":""}},[_c('v-flex',{attrs:{"xs12":"","md4":"","lg3":"","my-4":""}},[_c('v-text-field',{attrs:{"label":"Κωδικός είδους","color":"green","counter":50,"rules":_vm.kodikosules},model:{value:(_vm.deigmaXPressThreat.kodikos),callback:function ($$v) {_vm.$set(_vm.deigmaXPressThreat, "kodikos", $$v)},expression:"deigmaXPressThreat.kodikos"}})],1),_vm._v(" "),_c('v-flex',{attrs:{"xs12":"","md4":"","lg3":"","my-4":""}},[_c('v-text-field',{attrs:{"label":"Τύπος πίεσης","color":"green","counter":50,"rules":_vm.typeRules},model:{value:(_vm.deigmaXPressThreat.type),callback:function ($$v) {_vm.$set(_vm.deigmaXPressThreat, "type", $$v)},expression:"deigmaXPressThreat.type"}})],1),_vm._v(" "),_c('v-flex',{attrs:{"xs12":"","md6":"","lg3":"","my-4":""}},[_c('v-text-field',{attrs:{"label":"Σημασία","color":"green","counter":50,"rules":_vm.importanceRules},model:{value:(_vm.deigmaXPressThreat.importance),callback:function ($$v) {_vm.$set(_vm.deigmaXPressThreat, "importance", $$v)},expression:"deigmaXPressThreat.importance"}})],1)],1),_vm._v(" "),_c('v-layout',{attrs:{"justify-space-around":""}},[_c('h3',{staticClass:"font-weight-medium mt-2"},[_vm._v("Id: "+_vm._s(_vm.id)+" ")]),_vm._v(" "),_c('v-spacer'),_vm._v(" "),_c('v-btn',{staticStyle:{"text-transform":"none"},attrs:{"color":"light-green lighten-1","dark":""},on:{"click":function($event){return _vm.saveChanges()}}},[_vm._v("Αποθήκευση αλλαγών "),_c('v-icon',{attrs:{"small":"","right":""}},[_vm._v("save")])],1)],1)],1)],1)],1)]):_vm._e()],1),_vm._v(" "),_c('v-snackbar',{attrs:{"timeout":14000,"color":_vm.snackbarColor,"multi-line":true,"auto-height":true},model:{value:(_vm.snackbar),callback:function ($$v) {_vm.snackbar=$$v},expression:"snackbar"}},[_c('p',{staticClass:"pt-2"},[_vm._v(" "+_vm._s(_vm.snackbarText)+" ")])])],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/ornithopanida/deigma-ornithopanida-x-press-threats/_id/edit.vue?vue&type=template&id=4e0e93e0&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/ornithopanida/deigma-ornithopanida-x-press-threats/_id/edit.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var editvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    checkForNulls(data) {
      if (data.deigmaOrnithopanida != null && data.ctornithopanidaPressuresAndThreats != null && data.kodikos != null && data.type != null && data.importance != null && data.fulo != null && data.plhthos != null && data.eokParII != null && data.eokParIV != null && data.eokParV != null) {
    ...
    checkForSavingTheSame() {
      if ((this.deigmaXPressThreat.deigmaOrnithopanida.id == this.returnedObject.deigmaOrnithopanida.id || this.deigmaXPressThreat.deigmaOrnithopanida.id == '' && this.returnedObject.deigmaOrnithopanida.id == null) && (this.deigmaXPressThreat.ctornithopanidaPressuresAndThreats.actCode == this.returnedObject.ctornithopanidaPressuresAndThreats.actCode || this.deigmaXPressThreat.ctornithopanidaPressuresAndThreats.actCode == '' && this.returnedObject.ctornithopanidaPressuresAndThreats.actCode == null) && (this.deigmaXPressThreat.kodikos == this.returnedObject.kodikos || this.deigmaXPressThreat.kodikos == '' && this.returnedObject.kodikos == null) && (this.deigmaXPressThreat.type == this.returnedObject.type || this.deigmaXPressThreat.type == '' && this.returnedObject.type == null) && (this.deigmaXPressThreat.importance == this.returnedObject.importance || this.deigmaXPressThreat.importance == '' && this.returnedObject.importance == null)) {
        return true;
      }
    },
...
// CONCATENATED MODULE: ./pages/ornithopanida/deigma-ornithopanida-x-press-threats/_id/edit.vue?vue&type=script&lang=js&
 /* harmony default export */ var _id_editvue_type_script_lang_js_ = (editvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/ornithopanida/deigma-ornithopanida-x-press-threats/_id/edit.vue
