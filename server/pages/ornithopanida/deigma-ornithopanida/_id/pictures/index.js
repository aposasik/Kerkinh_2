...
/* harmony default export */ var picturesvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    restCall() {
      this.loading = true;
      this.$axios.get(this.getPictures + this.deigmaId).then(response => {
    ...
    deletePicture(pictureId) {
      this.$axios.delete(this.pictureById + pictureId).then(response => {
        if (response.data == false) {
          ...
          this.snackbar = true; // Re-calling the getPictures Method after the deletion
...
// CONCATENATED MODULE: ./pages/ornithopanida/deigma-ornithopanida/_id/pictures/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var _id_picturesvue_type_script_lang_js_ = (picturesvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/ornithopanida/deigma-ornithopanida/_id/pictures/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  _id_picturesvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
