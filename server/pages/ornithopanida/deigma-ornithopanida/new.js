...
module.exports.__inject__ = function (context) {
  add("9dd1f6d4", content, true, context)
};
...
/* harmony default export */ var newvue_type_script_lang_js_ = ({
  head() {
    return {
      title: 'Δείγμα Ορνιθοπανίδας - Δημιουργία | Φορέας Διαχείρισης Λίμνης Κερκίνης',
      meta: [{
        hid: 'description',
        name: 'description',
        content: 'Δημιουργία και αποθήκευση νέων δεδομένων τύπου Δείγματος Ορνιθοπανίδας -μέσω φόρμας ή αρχείου excel- για τον Φορέα Διαχείρισης Λίμνης Κερκίνης.'
      }]
    };
  },
  ...
  data() {
    return {
      main: {
        title: 'Εγγραφή νέου Δείγματος Ορνιθοπανίδας',
  ...
  computed: {
    ...
    addFormUrl() {
      return this.$store.getters.getDeigmaOrnithopanidaAddUrl;
    },

    addFromExcelUrl() {
      return this.$store.getters.getDeigmaOrnithopanidaAddFromExcelUrl;
    },
  ...
  methods: {
    ...
    submitForm() {
      ...
      checkedForm.kodikosDeigmatolipsias = this.form.kodikosDeigmatolipsias;
      ...
      if (!this.form.kodikosNatura == '') {
        checkedForm.kodikosNatura = this.form.kodikosNatura;
      }
      ...
      this.$axios.post(this.addFormUrl, checkedForm).then(response => {
        ...
        this.$router.push('/ornithopanida/deigma-ornithopanida/' + response.data.id);
      }).catch(error => {
        this.snackbarColor = 'red';
...
// CONCATENATED MODULE: ./pages/ornithopanida/deigma-ornithopanida/new.vue?vue&type=script&lang=js&
 /* harmony default export */ var deigma_ornithopanida_newvue_type_script_lang_js_ = (newvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/ornithopanida/deigma-ornithopanida/new.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  deigma_ornithopanida_newvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var deigma_ornithopanida_new = __webpack_exports__["default"] = (component.exports);
