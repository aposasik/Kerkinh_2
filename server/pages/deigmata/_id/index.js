...
/* harmony default export */ var _idvue_type_script_lang_js_ = ({
  head() {
    return {
      title: 'Δείγματα - Προβολή | Φορέας Διαχείρισης Λίμνης Κερκίνης',
      meta: [{
        hid: 'description',
        name: 'description',
        content: 'Προβολή συγκεκριμένου Δείγματος για τη διαχείρηση δεδομένων των Δειγμάτων για τον Φορέα Διαχείρισης Λίμνης Κερκίνης.'
      }]
    };
  },
  ...
  data() {
    return {
      ...
      deigma: {
        prwtokola: {},
        deigmaThhlastikwn: {} // Use farther deigmata types so and make a v-else-if for each one of them
  ...
  methods: {
    ...
    restCall(id) {
      ...
      this.$axios.get(this.getByIdUrl + id).then(response => {
        ...
        if (response.data == "") {
          ...
          this.snackbarText = 'Δεν βρέθηκε αποθηκευμένο το δείγμα που επιθυμείτε';
          this.snackbar = true;
        } else {
    ...
    goToDeigmaThhlastikwnById(id) {
      this.$router.push('/thhlastika/deigma-thhlastikwn/' + id);
    },

    toIdEditPage(id) {
      this.$router.push('/deigmata/' + id + '/edit');
    },
...
// CONCATENATED MODULE: ./pages/deigmata/_id/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var deigmata_idvue_type_script_lang_js_ = (_idvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/deigmata/_id/index.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  deigmata_idvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
