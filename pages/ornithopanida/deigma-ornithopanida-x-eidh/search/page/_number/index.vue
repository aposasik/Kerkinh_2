  ...
  <v-container fluid>
    ...
    justify-center>
      ...
      <v-flex v-else-if="noElements == false" xs12 lg10 style="margin-top: 100px;">
        <div >
          <h3 class="my-4 text-xs-center text-md-left font-weight-regular">Σύνολο Δειγμάτων X Ειδών : {{ this.returnedData.totalElements }} </h3>
        </div>
        <div v-for="deigmaXEidos in returnedData.content" :key="deigmaXEidos.id" class="my-5">
          <v-card my-2>
