  ...
  <v-container fluid>
    ...
    justify-center>
      ...
      <v-flex v-else-if="noElements == false" xs12 lg10 style="margin-top: 100px;">
        ...
        <div v-for="ctornithopanida in returnedData.content" :key="ctornithopanida.id" class="my-5">
          <v-card>
            ...
            <div class="pa-4">
              ...
              <v-layout>
                <h3 class="font-weight-medium mt-2">Id: {{ ctornithopanida.id }} </h3>
                <v-spacer></v-spacer>
                <v-btn @click="toIdPage(ctornithopanida.id)" color="green" dark style="text-transform: none">Εμφάνιση</v-btn>
              </v-layout>
            </div>
          </v-card>
        </div>
