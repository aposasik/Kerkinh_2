  ...
  <v-container fluid>
    ...
    justify-center>
      ...
      <v-flex v-else-if="noElements == false" xs12 lg9 style="margin-top: 100px;">
        <div>
          <h3 class="my-4 text-xs-center text-md-left font-weight-regular">Σύνολο Φωτογραφιών : {{ this.returnedData.totalElements }} </h3>
        </div>

        <div v-for="picture in returnedData.content" :key="picture.id" class="my-5">
          <v-card>
