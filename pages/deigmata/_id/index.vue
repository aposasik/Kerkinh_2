          ...
          <v-card>
            ...
            <v-layout wrap justify-space-between pa-4>
              ...
              <v-flex v-if="deigma.deigmaThhlastikwn != null" xs12 md5 lg3>
                ...
                <v-btn @click="goToDeigmaThhlastikwnById(deigma.deigmaThhlastikwn.id)" outline color="teal lighten-3" style="text-transform: none; margin-left: 0px;" title="Πλοήγηση προς το Δείγμα Θηλαστικών">Εύρεση</v-btn>
              </v-flex>
