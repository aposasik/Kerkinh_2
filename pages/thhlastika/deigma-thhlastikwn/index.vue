  ...
  data() {
    return {
      main: {
        ...
        texts: [
          '<span class="ml-3"></span>Στο menu παντώντας στο drop-list <b>Δείγμα θηλαστικών</b> σας ανοίγονται όλες οι υπάρχουσες επιλογές πλοήγησης. Από εκεί μπορείτε να επιλέξετε μεταξύ <b>Αναζήτησης</b>, <b>Δυναμικής Αναζήτησης</b>, πλοήγηση προς τα <b>Σχετίκα</b> (πληροφορίες), τον <b>Χάρτη</b> ή δημιουργία <b>Νέας Εγγραφής</b>.',
