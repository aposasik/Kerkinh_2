...
/* harmony default export */ var _numbervue_type_script_lang_js_ = ({
  head() {
    return {
      title: 'Ct Είδη Θηλαστικών - Αναζήτηση | Φορέας Διαχείρισης Λίμνης Κερκίνης',
      meta: [{
        hid: 'description',
        name: 'description',
        content: 'Αναζήτηση (δεδομένων) Ct Ειδών Θηλαστικών για τον Φορέα Διαχείρισης Λίμνης Κερκίνης.'
      }]
    };
  },
  ...
  computed: {
    searchUrl() {
      return this.$store.getters.getThhlastikaCtEidosSearchUrl;
    },
  ...
  methods: {
    ...
    getPrevPage() {
      this.$router.push('/thhlastika/ct-eidh/search/page/' + (this.paramPage - 1));
    },
...
// CONCATENATED MODULE: ./pages/thhlastika/ct-eidh/search/page/_number/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var page_numbervue_type_script_lang_js_ = (_numbervue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/thhlastika/ct-eidh/search/page/_number/index.vue
