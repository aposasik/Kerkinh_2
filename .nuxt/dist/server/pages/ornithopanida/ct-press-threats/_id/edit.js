...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/ornithopanida/ct-press-threats/_id/edit.vue?vue&type=template&id=21908b8f&
...
// CONCATENATED MODULE: ./pages/ornithopanida/ct-press-threats/_id/edit.vue?vue&type=template&id=21908b8f&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/ornithopanida/ct-press-threats/_id/edit.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var editvue_type_script_lang_js_ = ({
  head() {
    return {
      ...
      meta: [{
        hid: 'description',
        name: 'description',
        content: 'Επεξεργασία συγκεκριμένου Ct Πίεσης Ορνιθοπανιδα για τη διαχείρηση δεδομένων των Ct Πιέσεων Θηλαστικών για τον Φορέα Διαχείρισης Λίμνης Κερκίνης.'
      }]
    };
  },
  ...
  computed: {
    getByIdUrl() {
      return this.$store.getters.getOrnithopanidaCtPressThreatsByIdUrl;
    },
      ...
      if (this.checkForSavingTheSame() == true) {
        ...
        this.$axios.patch(this.getByIdUrl + this.id, patchedCt).then(response => {
          if (response.data == false) {
            ...
            this.snackbar = true;
            this.$router.push('/ornithopanida/ct-press-threats/' + this.id);
...
// CONCATENATED MODULE: ./pages/ornithopanida/ct-press-threats/_id/edit.vue?vue&type=script&lang=js&
 /* harmony default export */ var _id_editvue_type_script_lang_js_ = (editvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/ornithopanida/ct-press-threats/_id/edit.vue
